package io.mosip.mock.sbi.scanner.scanner.ResponseGenerator;

import static io.mosip.mock.sbi.utility.utility.DeviceConstants.CERTIFICATION_L1;
import static io.mosip.mock.sbi.utility.utility.DeviceConstants.ServiceStatus.NOT_REGISTERED;
...
import io.mosip.mock.sbi.dto.dto.DeviceInfo;
...
import io.mosip.mock.sbi.dto.dto.NewBioDto;
import io.mosip.mock.sbi.faceCaptureApi.faceCaptureApi.CaptureResult;
import io.mosip.mock.sbi.secureLib.secureLib.DeviceKeystore;
import io.mosip.mock.sbi.utility.utility.CommonDeviceAPI;
import io.mosip.mock.sbi.utility.utility.CryptoUtility;
import io.mosip.mock.sbi.utility.utility.DeviceConstants;
import io.mosip.mock.sbi.utility.utility.DeviceErrorCodes;
import io.mosip.mock.sbi.utility.utility.DeviceUtil;
import io.mosip.mock.sbi.utility.utility.Logger;
