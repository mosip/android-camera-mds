...
public class ResponseGenHelper 
{
	...
	private static NewBioAuthDto getBioResponse(CommonDeviceAPI mdCommonDeviceAPI, String bioType, String bioSubType,
		...
		List<String> exceptions = Arrays.asList(captureRequestDto.mosipBioRequest.get(0).exception == null ?
				new String[]{} : captureRequestDto.mosipBioRequest.get(0).exception);
