...
import static nprime.reg.mocksbi.utility.DeviceConstants.CERTIFICATION_L0;
...
public class DeviceUtil {
    ...
    public DeviceUtil(String deviceUsage) {
        if (deviceUsage.equals(DeviceConstants.DeviceUsage.Registration.getDeviceUsage())) {
            CERTIFICATION_LEVEL = CERTIFICATION_L0; //L0, L1, L2
            ...
            CERTIFICATION_LEVEL = CERTIFICATION_L1; //L0, L1, L2
